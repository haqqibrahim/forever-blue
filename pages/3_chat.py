...
from ai.assistant import get_groq_assistant  # type: ignore
...
def main() -> None:
    ...
    if "rag_assistant" not in st.session_state or st.session_state["rag_assistant"] is None:
        ...
        rag_assistant = get_groq_assistant(llm_model=llm_model, embeddings_model=embeddings_model, user_grade=user_grade)
    ...
    if rag_assistant.storage:
        ...
        new_rag_assistant_run_id = st.sidebar.selectbox("Chat ID", options=rag_assistant_run_ids)
